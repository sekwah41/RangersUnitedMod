...
public class ModelMightyMorphinBlue_model<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("rangersunited", "model_mighty_morphin_blue_model"), "main");
	...
	public ModelMightyMorphinBlue_model(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Goggles16 = Head.addOrReplaceChild("Goggles16",
				CubeListBuilder.create().texOffs(0, 70).addBox(1.55F, -6.33F, -2.55F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, -0.1745F));
		PartDefinition Goggles22 = Head.addOrReplaceChild("Goggles22",
				CubeListBuilder.create().texOffs(0, 43).addBox(-4.35F, -1.67F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Goggles26 = Head.addOrReplaceChild("Goggles26",
				CubeListBuilder.create().texOffs(0, 70).addBox(-1.9F, -4.65F, -4.47F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2618F, 0.5236F));
		PartDefinition HeadBit4 = Head.addOrReplaceChild("HeadBit4",
				CubeListBuilder.create().texOffs(18, 80).addBox(-4.1F, -6.0F, -3.89F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Goggles7 = Head.addOrReplaceChild(
				"Goggles7", CubeListBuilder.create().texOffs(0, 70).mirror()
						.addBox(-4.18F, -6.33F, -2.55F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.1745F));
		PartDefinition Goggles15 = Head.addOrReplaceChild("Goggles15",
				CubeListBuilder.create().texOffs(0, 70).addBox(2.18F, -6.33F, -2.55F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, -0.1745F));
		...
		PartDefinition Goggles24 = Head.addOrReplaceChild("Goggles24",
				CubeListBuilder.create().texOffs(0, 70).addBox(0.9F, -5.17F, -4.47F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.2618F, -0.5236F));
		...
		PartDefinition Goggles17 = Head.addOrReplaceChild("Goggles17",
				CubeListBuilder.create().texOffs(0, 70).addBox(-7.53F, -1.5F, -2.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.2618F, 0.8727F));
		PartDefinition Goggles19 = Head.addOrReplaceChild("Goggles19",
				CubeListBuilder.create().texOffs(0, 43).addBox(3.35F, -1.67F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.4363F));
		PartDefinition HeadBit1 = Head.addOrReplaceChild("HeadBit1",
				CubeListBuilder.create().texOffs(18, 90).addBox(-1.5F, -8.2F, -4.3F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles25 = Head.addOrReplaceChild("Goggles25",
				CubeListBuilder.create().texOffs(0, 70).addBox(-1.9F, -5.17F, -4.47F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2618F, 0.5236F));
		PartDefinition MouthFix2 = Head.addOrReplaceChild("MouthFix2",
				...
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.5585F));
		PartDefinition Goggles9 = Head.addOrReplaceChild("Goggles9",
				CubeListBuilder.create().texOffs(0, 70).addBox(6.53F, -1.5F, -2.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2618F, -0.8727F));
		PartDefinition Horn3 = Head.addOrReplaceChild("Horn3",
				CubeListBuilder.create().texOffs(0, 73).addBox(-4.3F, -8.3F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition HeadBit6 = Head.addOrReplaceChild("HeadBit6",
				CubeListBuilder.create().texOffs(18, 80).addBox(3.1F, -6.0F, -3.89F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles27 = Head.addOrReplaceChild("Goggles27",
				CubeListBuilder.create().texOffs(0, 70).addBox(0.9F, -4.65F, -4.47F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.2618F, -0.5236F));
		PartDefinition Eye1 = Head.addOrReplaceChild("Eye1",
				CubeListBuilder.create().texOffs(130, 50).addBox(-4.5F, -7.8F, -2.18F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.1745F));
		...
		PartDefinition Eye2 = Head.addOrReplaceChild("Eye2",
				CubeListBuilder.create().texOffs(130, 50).addBox(3.5F, -7.8F, -2.18F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, -0.1745F));
		PartDefinition Horn1 = Head.addOrReplaceChild("Horn1",
				CubeListBuilder.create().texOffs(0, 73).addBox(-0.5F, -8.4F, -4.43F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles13 = Head.addOrReplaceChild("Goggles13",
				CubeListBuilder.create().texOffs(0, 70).addBox(-2.55F, -6.33F, -2.55F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.1745F));
		...
		PartDefinition Horn2 = Head.addOrReplaceChild("Horn2",
				CubeListBuilder.create().texOffs(0, 73).addBox(3.2F, -8.3F, -3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Goggles20 = Head.addOrReplaceChild("Goggles20",
				CubeListBuilder.create().texOffs(0, 43).addBox(4.08F, -1.67F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.4363F));
		PartDefinition Goggles21 = Head.addOrReplaceChild("Goggles21",
				CubeListBuilder.create().texOffs(0, 43).addBox(-2.55F, -2.67F, -4.7F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.0873F));
		PartDefinition Goggles23 = Head.addOrReplaceChild("Goggles23",
				CubeListBuilder.create().texOffs(0, 43).addBox(-5.08F, -1.67F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.4363F));
		...
		PartDefinition Goggles8 = Head.addOrReplaceChild("Goggles8",
				CubeListBuilder.create().texOffs(0, 43).addBox(0.55F, -2.67F, -4.7F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.0873F));
