...
public class ModelMightyMorphinPink<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Goggles15 = Head.addOrReplaceChild("Goggles15",
				CubeListBuilder.create().texOffs(0, 43).addBox(3.37F, -5.68F, -2.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Goggles8 = Head.addOrReplaceChild("Goggles8",
				CubeListBuilder.create().texOffs(0, 43).addBox(1.15F, -2.49F, -4.65F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.2618F));
		PartDefinition Horn1 = Head.addOrReplaceChild("Horn1",
				CubeListBuilder.create().texOffs(27, 90).addBox(-2.68F, -7.4F, -2.65F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition HeadBit1 = Head.addOrReplaceChild("HeadBit1",
				CubeListBuilder.create().texOffs(18, 90).addBox(-1.0F, -8.2F, -4.25F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles21 = Head.addOrReplaceChild("Goggles21",
				CubeListBuilder.create().texOffs(0, 43).addBox(-4.15F, -2.49F, -4.65F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.2618F));
		...
		PartDefinition HeadBit3 = Head.addOrReplaceChild("HeadBit3",
				CubeListBuilder.create().texOffs(15, 80).addBox(-0.5F, -8.45F, -3.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Goggles7 = Head.addOrReplaceChild(
				"Goggles7", CubeListBuilder.create().texOffs(0, 43).mirror()
						.addBox(-4.36F, -5.68F, -2.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.5236F));
		...
		PartDefinition Belt5 = Body.addOrReplaceChild("Belt5",
				CubeListBuilder.create().texOffs(0, 49).addBox(2.4F, 11.0F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition D3_2 = RightLeg.addOrReplaceChild("D3_2",
				...
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.2618F, 0.6109F));
		PartDefinition Skirt3 = RightLeg.addOrReplaceChild("Skirt3",
				CubeListBuilder.create().texOffs(15, 80).addBox(-2.0F, -0.1F, 1.1F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition DLEG4 = RightLeg.addOrReplaceChild("DLEG4",
				...
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Skirt1 = RightLeg.addOrReplaceChild("Skirt1",
				CubeListBuilder.create().texOffs(15, 80).addBox(-2.0F, -0.1F, -2.1F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
		PartDefinition Skirt2 = RightLeg.addOrReplaceChild("Skirt2",
				CubeListBuilder.create().texOffs(15, 80).addBox(-2.1F, -0.1F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition D8_3 = LeftLeg.addOrReplaceChild("D8_3",
				CubeListBuilder.create().texOffs(0, 35).addBox(1.3F, 5.8F, 5.55F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6109F, 0.0F, 0.0F));
		PartDefinition Skirt1_1 = LeftLeg.addOrReplaceChild("Skirt1_1",
				CubeListBuilder.create().texOffs(15, 80).addBox(-2.0F, -0.1F, -2.1F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition DLEG2_1 = LeftLeg.addOrReplaceChild("DLEG2_1", CubeListBuilder.create().texOffs(71, 70).mirror()
				.addBox(1.2F, 6.0F, -2.0F, 1.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Skirt2_1 = LeftLeg.addOrReplaceChild("Skirt2_1",
				CubeListBuilder.create().texOffs(15, 80).addBox(1.1F, -0.1F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		...
		PartDefinition Skirt3_1 = LeftLeg.addOrReplaceChild("Skirt3_1",
				CubeListBuilder.create().texOffs(15, 80).addBox(-2.0F, -0.1F, 1.1F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.0F, 0.0F));
