...
public class ModelMightyMorphinBlack_model<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("rangersunited", "model_mighty_morphin_black_model"), "main");
	...
	public ModelMightyMorphinBlack_model(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition HeadBit3 = Head.addOrReplaceChild("HeadBit3",
				CubeListBuilder.create().texOffs(15, 80).addBox(-2.5F, -8.35F, -2.5F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles27 = Head.addOrReplaceChild("Goggles27",
				CubeListBuilder.create().texOffs(0, 74).addBox(3.69F, -5.58F, -3.08F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2618F, 0.0F));
		PartDefinition Goggles15 = Head.addOrReplaceChild("Goggles15",
				CubeListBuilder.create().texOffs(0, 70).addBox(0.3F, -6.5F, -2.48F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Goggles21 = Head.addOrReplaceChild("Goggles21",
				CubeListBuilder.create().texOffs(0, 51).addBox(-2.55F, -2.66F, -4.63F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.0873F));
		PartDefinition Goggles26 = Head.addOrReplaceChild("Goggles26",
				CubeListBuilder.create().texOffs(0, 74).addBox(-0.8F, -3.57F, -4.95F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.6109F));
		...
		PartDefinition Goggles23 = Head.addOrReplaceChild("Goggles23",
				CubeListBuilder.create().texOffs(0, 74).addBox(-4.92F, -1.5F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.4363F));
		PartDefinition Goggles8 = Head.addOrReplaceChild("Goggles8",
				CubeListBuilder.create().texOffs(0, 51).addBox(0.55F, -2.66F, -4.63F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.0873F));
		...
		PartDefinition Goggles24 = Head.addOrReplaceChild("Goggles24",
				CubeListBuilder.create().texOffs(0, 74).addBox(-4.69F, -5.58F, -3.08F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.2618F, 0.0F));
		...
		PartDefinition Goggles25 = Head.addOrReplaceChild("Goggles25",
				CubeListBuilder.create().texOffs(0, 74).addBox(-0.2F, -3.57F, -4.95F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.6109F));
		PartDefinition Horn3 = Head.addOrReplaceChild("Horn3",
				CubeListBuilder.create().texOffs(16, 73).addBox(-4.4F, -8.4F, -3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles20 = Head.addOrReplaceChild("Goggles20",
				CubeListBuilder.create().texOffs(0, 74).addBox(3.92F, -1.5F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.4363F));
		PartDefinition Goggles7 = Head
				.addOrReplaceChild(
						"Goggles7", CubeListBuilder.create().texOffs(0, 70).mirror()
								.addBox(-3.3F, -6.5F, -2.48F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		PartDefinition HeadBit7 = Head.addOrReplaceChild("HeadBit7",
				CubeListBuilder.create().texOffs(18, 90).addBox(-1.5F, -8.2F, -4.4F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Goggles19 = Head.addOrReplaceChild("Goggles19",
				CubeListBuilder.create().texOffs(0, 74).addBox(3.35F, -1.5F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, -0.4363F));
		...
		PartDefinition Goggles22 = Head.addOrReplaceChild("Goggles22",
				CubeListBuilder.create().texOffs(0, 74).addBox(-4.35F, -1.5F, -4.43F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2618F, 0.0F, 0.4363F));
		PartDefinition Horn1 = Head.addOrReplaceChild("Horn1",
				CubeListBuilder.create().texOffs(20, 81).addBox(-0.5F, -7.2F, -4.63F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition Horn2 = Head.addOrReplaceChild("Horn2",
				CubeListBuilder.create().texOffs(15, 73).addBox(3.3F, -8.4F, -3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
